...
internal class ImplementationTypeFilter(IEnumerable<Type> types) : IImplementationTypeFilter
{
    internal IEnumerable<Type> Types { get; private set; } = types;

    public IImplementationTypeFilter AssignableTo<T>() => AssignableTo(typeof(T));
    ...
    public IImplementationTypeFilter WithAttribute<T>() where T : Attribute => WithAttribute(typeof(T));
    ...
    public IImplementationTypeFilter WithoutAttribute<T>() where T : Attribute => WithoutAttribute(typeof(T));
