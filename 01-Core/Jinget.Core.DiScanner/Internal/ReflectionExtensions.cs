...
internal static class ReflectionExtensions
{
    ...
    public static bool IsInExactNamespace(this Type type, string @namespace) => string.Equals(type.Namespace, @namespace, StringComparison.Ordinal);
    ...
    public static string ToFriendlyName(this Type type) => TypeNameHelper.GetTypeDisplayName(type, includeGenericParameterNames: true);

    public static bool IsOpenGeneric(this Type type) => type.IsGenericTypeDefinition;
