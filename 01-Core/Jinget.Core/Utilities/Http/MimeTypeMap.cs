...
public static class MimeTypeMap
{
    ...
    /// </summary>
    /// <param name="name">The filename or extension.</param>
    ...
    public static bool TryGetMimeType(string name, out string? mimeType)
    {
        ...
        var indexQuestionMark = name.IndexOf(QuestionMark, StringComparison.Ordinal);
        if (indexQuestionMark != -1)
        {
            name = name.Remove(indexQuestionMark);
        }
        ...
        return _mappings.Value.TryGetValue(name, out mimeType);
    }
