...
{
    public static void ConfigureSQLServerLogger<TOperationalEntity, TErrorEntity, TCustomEntity>(this IServiceCollection services, ElasticSearchSettingModel elasticSearchSetting = null)
    ...
    public static void ConfigureSQLServerLogger(this IServiceCollection services, ElasticSearchSettingModel elasticSearchSetting = null)
    {
        services.ConfigureJingetLoggerPrerequisites();
