...
public class HttpContextExtensionsTests
{
    ...
    public void GetClaimTitlesFromEndpoints_MultipleAttributes_ReturnsAllTitles()
    {
        ...
        Assert.AreSequenceEqual(expectedTitles, [.. titles], SequenceOrder.InAnyOrder);
    }
    ...
    public void GetClaimTitlesFromEndpoints_NullHttpContext_ThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        Assert.Throws<ArgumentNullException>(httpContext.GetClaimTitlesFromEndpoints<ClaimAttribute>);
    }
}